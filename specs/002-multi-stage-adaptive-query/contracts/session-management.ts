 ...
 */
export declare function getSessionContext(sessionId: string): ContextState | null;
 ...
 */
export declare function saveSessionListToStorage(sessions: SessionMetadata[]): void;
...
export class SessionError extends Error {
  constructor(
    message: string,
    public code: 'NOT_FOUND' | 'ALREADY_EXISTS' | 'INVALID_STATE' | 'STORAGE_ERROR',
