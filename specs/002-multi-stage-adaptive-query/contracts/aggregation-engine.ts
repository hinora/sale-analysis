 ...
 * ```
 */
export declare function formatAggregationForAI(result: AggregationResult): string;
 ...
 * @returns Compact text representation
 */
export declare function formatAggregationsForAI(results: AggregationResult[]): string;
...
export class AggregationError extends Error {
  constructor(
    message: string,
    public code: 'INVALID_SPEC' | 'FIELD_NOT_FOUND' | 'SESSION_NOT_FOUND' | 'NO_DATA' | 'COMPUTATION_FAILED',
